...
2. After implementing functionality or resolving problems, run the game to verify it works: `node src/index.js`. Run any tests with `node --test src/**/*.test.js`. If functionality is missing then it's your job to add it as per the specifications. Ultrathink.
...
9999999999. When you learn something new about how to run the project, update @AGENTS.md using a subagent but keep it brief.

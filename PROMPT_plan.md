...
ULTIMATE GOAL: Build a polished, fully-featured CLI blackjack (21) game in Node.js that plays beautifully in the terminal. The game should have clean ASCII card art, smooth gameplay flow, proper blackjack rules, and a premium visual feel. Consider missing elements and plan accordingly. If an element is missing, search first to confirm it doesn't exist, then if needed author the specification at specs/FILENAME.md. If you create a new element then document the plan to implement it in @IMPLEMENTATION_PLAN.md using a subagent.
